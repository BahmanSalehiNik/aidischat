...
class KafkaWrapper {
    ...
    consumer(groupId) {
        ...
        return this._client.consumer({
            ...
            maxInFlightRequests: 5, // Higher throughput - posts are independent, order doesn't matter
            ...
            this._client = new kafkajs_1.Kafka({
                ...
                logCreator: () => ({ level, log, namespace, label }) => {
                    ...
                    if ((logMessage === null || logMessage === void 0 ? void 0 : logMessage.includes('does not host this topic-partition')) ||
                        ...
                        ((logMessage === null || logMessage === void 0 ? void 0 : logMessage.includes('Response Metadata')) && (errorMessage === null || errorMessage === void 0 ? void 0 : errorMessage.includes('does not host')))) {
