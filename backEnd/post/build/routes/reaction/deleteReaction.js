...
exports.deletePostReactionRouter = void 0;
...
exports.deletePostReactionRouter = router;
router.delete('/api/posts/:postId/reactions', shared_1.extractJWTPayload, shared_1.loginRequired, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.jwtPayload.id;
    const postId = req.params.postId;
    const reaction = yield reaction_1.Reaction.findOne({ userId, postId, commentId: { $exists: false } });
    if (!reaction) {
