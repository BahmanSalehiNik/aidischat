...
router.delete('/api/posts/:postId/comments/:commentId', shared_1.extractJWTPayload, shared_1.loginRequired, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield new commentPublishers_1.CommentDeletedPublisher(kafka_client_1.kafkaWrapper.producer).publish({
        id: comment.id,
