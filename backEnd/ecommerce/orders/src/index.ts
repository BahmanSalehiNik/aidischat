...
import { AiModelCardCreatedListener, AiModelCardUpdatedListener } from "./events/listeners/aiModelCardListeners";
...
const startMongoose = async ()=>{
    ...
    new AiModelCardCreatedListener(natsClient.client).listen() 
    new AiModelCardUpdatedListener(natsClient.client).listen() 
