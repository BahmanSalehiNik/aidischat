...
import { FreindshipAcceptedListener, 
    FreindshipUpdatedListener, 
    FreindshipRequestedListener } from "./events/listeners/friendship/friendshipListener";
...
app.listen(3000, ()=>{
    console.log("app listening on port 3000! feed")
})
